        ...
        <div class="ps-breadcrumb">
            <div class="container">
                <ul class="ps-breadcrumb__list">
                    ...
                    <li class="active"><a href="shop.html">Bakery</a></li>
                    <li class="active"><a href="shop.html">Bread</a></li>
                    <li><a href="javascript:void(0);">Hovis Farmhouse Soft White Bread</a></li>
                </ul>
            </div>
        </div>
        <section class="section--product-type">
            <div class="container">
                <div class="product__header">
                    <h3 class="product__name">Hovis Farmhouse Soft White Bread</h3>
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-9">
                            <div class="ps-product--detail">
                                <div class="row">
                                    <div class="col-12 col-lg-6">
                                        <div class="ps-product__variants">
                                            <div class="ps-product__gallery">
                                                <div class="ps-gallery__item active"><img src="img/products/03-Bakery/03_1a.jpg" alt="alt" /></div>
                                                <div class="ps-gallery__item">><img class="ps-product__thumbnail" src="{{asset('image/produk/nav.jpeg')}}" alt="alt" /></div>
                                                <div class="ps-gallery__item"><img src="img/products/03-Bakery/03_1a.jpg" alt="alt" /></div>
                                                <div class="ps-gallery__item"><img src="img/products/03-Bakery/03_1b.jpg" alt="alt" /></div>
                                                <div class="ps-gallery__item"><img src="img/products/03-Bakery/03_1a.jpg" alt="alt" /></div>
                                                <div class="ps-gallery__item"><img src="img/products/03-Bakery/03_1b.jpg" alt="alt" /></div>
                                                <div class="ps-gallery__item"><img src="img/products/03-Bakery/03_1a.jpg" alt="alt" /></div>
                                                <div class="ps-gallery__item"><img src="img/products/03-Bakery/03_1b.jpg" alt="alt" /></div>
                                            ...
                                            <div class="ps-product__thumbnail">
                                                <div class="ps-product__zoom"><img id="ps-product-zoom" src="img/products/03-Bakery/03_1a.jpg" alt="alt" />
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="ps-product__sale"><span class="price-sale">$5.49</span><span class="price">$6.90</span><span class="ps-product__off">15% Off</span>
                                        </div>
                                        <div class="ps-product__unit">300g</div>
        ...
        <section class="section-recent--default ps-home--block">
            <div class="container">
                ...
                <div class="recent__content">
                    <div class="owl-carousel" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="8" data-owl-item-xs="3" data-owl-item-sm="3" data-owl-item-md="5" data-owl-item-lg="8" data-owl-item-xl="8" data-owl-duration="1000" data-owl-mousedrag="on"><a class="recent-item" href="index.html"><img src="img/products/01-Fresh/01_1a.jpg" alt="alt" /></a><a class="recent-item" href="index.html"><img src="img/products/01-Fresh/01_2a.jpg" alt="alt" /></a><a class="recent-item" href="index.html"><img src="img/products/01-Fresh/01_30a.jpg" alt="alt" /></a><a class="recent-item" href="index.html"><img src="img/products/01-Fresh/01_10a.jpg" alt="alt" /></a><a class="recent-item" href="index.html"><img src="img/products/01-Fresh/01_18a.jpg" alt="alt" /></a><a class="recent-item" href="index.html"><img src="img/products/01-Fresh/01_28b.jpg" alt="alt" /></a><a class="recent-item" href="index.html"><img src="img/products/01-Fresh/01_16a.jpg" alt="alt" /></a><a class="recent-item" href="index.html"><img src="img/products/01-Fresh/01_31a.jpg" alt="alt" /></a><a class="recent-item" href="index.html"><img src="img/products/01-Fresh/01_15a.jpg" alt="alt" /></a><a class="recent-item" href="index.html"><img src="img/products/01-Fresh/01_5a.jpg" alt="alt" /></a><a class="recent-item" href="index.html"><img src="img/products/01-Fresh/01_32a.jpg" alt="alt" /></a>
                    </div>
                </div>
            </div>
        </section>
